...
-(NSString *)description{
    return [NSString stringWithFormat:@"NHAttentionModel[title=%@,detailTitle=%@,image=%@,button=%@,buttonTitle=%@,buttonTitleColor=%@]",self.title,self.detailTitle,self.image,self.button,self.buttonTitle,@(self.buttonTitleColor)];
}
